...
function init() {
   ...
   const width = document.getElementById('three-container').getAttribute('p-width');
   const height = document.getElementById('three-container').getAttribute('p-height');

   const slide = new Slide(width, height, 'out');
   const l1 = new THREE.ImageLoader();
   l1.setCrossOrigin('Anonymous');
   l1.load(document.getElementById('three-container').getAttribute('p1-href'), function (img) {
      slide.setImage(img);
   })
   ...
   l2.load(document.getElementById('three-container').getAttribute('p2-href'), function (img) {
      slide2.setImage(img);
   })
